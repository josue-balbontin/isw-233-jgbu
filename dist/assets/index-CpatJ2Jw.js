...
`,p=class extends HTMLElement{constructor(){super(),this.url=`./data/blog.json`}async connectedCallback(){this.crearBlog();let e=(await this.obtener()).slice(0,3).map(e=>u.crearTarjeta(e)).join(``);this.querySelector(`.blog__lista`).innerHTML=e}crearBlog(){this.innerHTML=f}};Object.assign(p.prototype,c),customElements.define(`app-blog`,p);var m=`/assets/pasa-fQPrKlgm.png`,h=`/assets/arqui-t8VJmWZC.png`,g=`/assets/tickets-CfDvf86K.png`,_=`/assets/inds_inspectionpng-BaUl5Itb.png`,v=`/assets/whitebelt-CJdpXzOX.png`,y=`/assets/google-CfQ1KjUP.png`,b=`<section class="experiencia">
        ...
        <div class="experiencia__lista">
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="${m}" alt="Captura de pantalla del Proyecto 1">
            </div>
            ...
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="${g}" alt="Captura de pantalla del Proyecto 3">
            </div>
            <button class="boton boton--informacion">Ver más proyectos</button>
        </div>
    </section>`,x=`<section class="experiencia">
        ...
        <div class="experiencia__lista">
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="${_}" alt="Certificado 1">
            </div>
            
            <div class="experiencia__proyecto">
                <img class="experiencia__imagen" src="${v}" alt="Certificado 2">     
                <div>
            ...
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="${y}" alt="Certificado 3">
            </div>
            <button class="boton boton--informacion">Ver más certificados</button>
        </div>
    </section>`,S=class extends HTMLElement{constructor(){super(),this.crearExperiencia()}crearExperiencia(){this.innerHTML=b+x}};customElements.define(`app-experiencia`,S);var C={enrutar(){document.querySelectorAll(`a.nav__link`).forEach(e=>{e.addEventListener(`click`,e=>{e.preventDefault();let t=e.target.getAttribute(`href`);this.ir(t)})}),window.addEventListener(`popstate`,e=>{this.ir(e.state.route,!1)}),this.ir(location.pathname)},ir(e,t=!0){switch(t&&history.pushState({route:e},``,e),e){case`/about`:document.getElementById(`main`).innerHTML=`<page-about></page-about>`;break;case`/proyectos`:document.getElementById(`main`).innerHTML=`<page-proyecto></page-proyecto>`;break;case`/blog`:document.getElementById(`main`).innerHTML=`<page-blog></page-blog>`;break;case`/contacto`:document.getElementById(`main`).innerHTML=`<page-contacto></page-contacto>`;break;default:document.getElementById(`main`).innerHTML=`<app-home></app-home>`}}},w=`    <app-presentacion></app-presentacion>

    <app-sobre-mi></app-sobre-mi>
    
    <app-experiencia></app-experiencia>
    
    <app-blog></app-blog>`,T=class extends HTMLElement{constructor(){super(),this.crearHome()}crearHome(){this.innerHTML=w}};customElements.define(`app-home`,T);var E=`.page-about{margin:5%;font-family:Fira Code,monospace}.page-about__titulo{color:#ffd700f2;-webkit-text-stroke-width:1px;-webkit-text-stroke-color:#000;font-size:4rem;font-style:normal;font-weight:450;line-height:normal}.page-about__imagen{border-radius:50%;width:60%;margin:0 auto;display:block}.page-about__nombre{text-align:center;margin:0;font-family:Inter}`,D=`
...
`,O=class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.crearHtml()}crearHtml(){this.shadow.innerHTML=D;let e=document.createElement(`style`);e.innerHTML=E,this.shadow.appendChild(e)}};customElements.define(`page-about`,O);var k=`:host{--num-columnas:auto-fit;width:100%;display:block}.grilla{grid-template-columns:repeat(var(--num-columnas), minmax(300px, 1fr));-moz-column-gap:20px;gap:42px 20px;width:100%;display:grid}::slotted(*){height:100%}`,A=document.createElement(`template`);A.innerHTML=`
    
    <div class="grilla">
        <slot></slot>
    </div>

`;var j=class extends HTMLElement{constructor(){super(),this.DOM=this.attachShadow({mode:`open`})}connectedCallback(){this.crearHTML();let e=this.getAttribute(`columnas`)||`auto-fit`;this.style.setProperty(`--num-columnas`,e)}crearHTML(){this.DOM.appendChild(A.content.cloneNode(!0));let e=document.createElement(`style`);e.innerHTML=k,this.DOM.appendChild(e)}};customElements.define(`app-grilla`,j);var M=`.page-proyecto{margin:5%;font-family:Open Sans,sans-serif}.page-proyecto__titulo{color:gold;margin:0 0 .8rem;font-family:Fira Code,monospace;font-size:1.9rem;font-weight:400}app-grilla{margin-top:.4rem}app-tarjeta{background-color:#2c2c2c;border:1px solid #4b4b4a;border-radius:.6rem;padding:.7rem}`,N=`
...
`,P=class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.datos=[],this.url=`./data/proyecto.json`}async connectedCallback(){this.crearHTML(),await this.cargarDatos(),this.imprimirProyectos()}crearHTML(){this.shadow.innerHTML=N;let e=document.createElement(`style`);e.innerHTML=M,this.shadow.appendChild(e)}async cargarDatos(){this.datos=await this.obtener()}imprimirProyectos(){let e=this.shadow.querySelector(`app-grilla`);e.innerHTML=this.datos.map(e=>u.crearTarjeta(e)).join(``)}};Object.assign(P.prototype,c),customElements.define(`page-proyecto`,P);var F={detectarCambio:function(e,t,n){t.addEventListener(`click`,()=>{let t=e.value;n(t)})}},I={normalizarTexto(e){return e.toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``)},filtrar(e,t,n){return e.filter(e=>this.normalizarTexto(e[t]).includes(this.normalizarTexto(n)))},filtrarSensible(e,t,n){return e.filter(e=>e[t].includes(n))},obtenerValoresUnicos(e,t){let n=e.map(e=>e[t]);return[...new Set(n)]}},L={favoritos:new Set,agregarFavorito(e){this.favoritos.add(String(e))},eliminarFavorito(e){this.favoritos.delete(String(e))},esFavorito(e){return this.favoritos.has(String(e))},obtenerFavoritos(){return Array.from(this.favoritos)}},R=class{constructor(e,t){this.opciones=e,this.callback=t,this.observer=new IntersectionObserver(this.callback,this.opciones)}observar(e){e&&this.observer.observe(e)}dejarDeObservar(e){e&&this.observer.unobserve(e)}destructor(){this.observer&&this.observer.disconnect()}},z=class{constructor(e){this.callback=e,this.observer=new MutationObserver(this.callback)}observar(e,t){e&&this.observer.observe(e,t)}destructor(){this.observer&&this.observer.disconnect()}},B=`.page-blog{margin:5%;font-family:Open Sans,sans-serif}.page-blog__titulo{color:gold;margin:0 0 .8rem;font-family:Fira Code,monospace;font-size:1.9rem;font-weight:400}.page-blog__buscador{flex-flow:column wrap;justify-content:center;align-items:center;gap:.5rem;width:100%;padding:.6rem 0 1rem;display:flex}.page-blog__input-buscar{color:#fff;background-color:#1f1f1f;border:1px solid #4b4b4a;border-radius:.5rem;min-width:220px;padding:.5rem .7rem}.page-blog__boton-categoria,.page-blog__boton-buscar{color:#000;background-color:gold;border:1px solid #000;border-radius:.5rem;padding:.5rem .9rem;font-weight:700}.page-blog__categorias{flex-wrap:wrap;justify-content:center;gap:.5rem;display:flex}.page-blog__categorias p{color:#fff;background-color:#1f1f1f;border:1px solid #4b4b4a;border-radius:.4rem;margin:0;padding:.2rem .8rem}.page-blog__categorias--oculto{display:none!important}.page-blog__boton-favorito{background-color:#0000;border:1px solid #5a5a5a;border-radius:.4rem;padding:.15rem .45rem;font-size:20px}.page-blog__boton-favorito--favorito{color:gold;border-color:gold}.page-blog__boton-favorito--no-favorito{color:gray}app-grilla{margin-top:.4rem}app-tarjeta{background-color:#2c2c2c;border:1px solid #4b4b4a;border-radius:.6rem;padding:.7rem}.page-blog__tarjeta-aparecer{will-change:opacity, transform;animation:.32s ease-out both page-blog-aparecer}@keyframes page-blog-aparecer{0%{opacity:0;transform:translateY(10px)scale(.99)}to{opacity:1;transform:translateY(0)scale(1)}}`,V=` 
...
`,H=class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.datos=[],this.datosFiltrados=[],this.categoriasvalores=[],this.datosTitulo=`titulo`,this.datosCategoria=`categoria`,this.url=`./data/blog.json`,this.observer=null,this.mutationObserver=null}async connectedCallback(){this.crearHTML(),this.iniciarMutationObserver(),await this.cargarDatos(),this.inicializarCategorias(),this.imprimirDatos(this.datos),this.buscador(),this.categorias(),this.inicializarFavoritos()}disconnectedCallback(){this.observer&&=(this.observer.destructor(),null),this.mutationObserver&&=(this.mutationObserver.destructor(),null)}crearHTML(){this.shadow.innerHTML=V;let e=document.createElement(`style`);e.innerHTML=B,this.shadow.appendChild(e)}async cargarDatos(){this.datos=await this.obtener(),this.categoriasvalores=I.obtenerValoresUnicos(this.datos,this.datosCategoria)}inicializarCategorias(){let e=this.shadow.querySelector(`.page-blog__categorias`);e.innerHTML=`<p>Todos</p>`+this.categoriasvalores.map(e=>`<p>${e}</p>`).join(``)}imprimirDatos(e){let t=e.map(e=>L.esFavorito(e.id)?d.crearTarjeta(e,` page-blog__boton-favorito page-blog__boton-favorito--favorito`,!0):d.crearTarjeta(e,`page-blog__boton-favorito page-blog__boton-favorito--no-favorito`,!0)).join(``);this.shadow.querySelector(`app-grilla`).innerHTML=t,this.iniciarIntersectionObserver()}iniciarIntersectionObserver(){this.observer&&this.observer.destructor(),this.observer=new R({root:null,rootMargin:`0px 0px 100px 0px`,threshold:0},e=>{e.forEach(e=>{if(e.isIntersecting){let t=e.target;t.dataset.imagen&&(t.src=t.dataset.imagen,t.removeAttribute(`data-imagen`)),this.observer.dejarDeObservar(t)}})}),this.shadow.querySelectorAll(`img[data-imagen]`).forEach(e=>{this.observer.observar(e)})}iniciarMutationObserver(){this.mutationObserver&&this.mutationObserver.destructor();let e=this.shadow.querySelector(`app-grilla`);e&&(this.mutationObserver=new z(e=>{e.forEach(e=>{e.type!==`childList`||e.addedNodes.length===0||e.addedNodes.forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&e.matches(`app-tarjeta`)&&e.classList.add(`page-blog__tarjeta-aparecer`)})})}),this.mutationObserver.observar(e,{childList:!0,subtree:!1}))}buscador(){let e=this.shadow.querySelector(`.page-blog__input-buscar`),t=this.shadow.querySelector(`.page-blog__boton-buscar`);F.detectarCambio(e,t,e=>{this.datosFiltrados=I.filtrar(this.datos,this.datosTitulo,e),e===``&&(this.datosFiltrados=this.datos),this.imprimirDatos(this.datosFiltrados)})}categorias(){let e=this.shadow.querySelector(`.page-blog__boton-categoria`),t=this.shadow.querySelector(`.page-blog__categorias`);e.addEventListener(`click`,()=>{t.classList.toggle(`page-blog__categorias--oculto`)}),t.addEventListener(`click`,e=>{if(e.target.matches(`p`)){let t=e.target.textContent;if(t===`Todos`){this.datosFiltrados=this.datos,this.imprimirDatos(this.datosFiltrados);return}this.datosFiltrados=I.filtrar(this.datos,this.datosCategoria,t),this.imprimirDatos(this.datosFiltrados)}})}inicializarFavoritos(){this.shadow.querySelector(`app-grilla`).addEventListener(`click`,e=>{let t=e.target.closest(`.page-blog__boton-favorito`);if(!t)return;let n=t.closest(`app-tarjeta`).id;L.esFavorito(n)?(L.eliminarFavorito(n),t.classList.replace(`page-blog__boton-favorito--favorito`,`page-blog__boton-favorito--no-favorito`)):(L.agregarFavorito(n),t.classList.replace(`page-blog__boton-favorito--no-favorito`,`page-blog__boton-favorito--favorito`))})}};Object.assign(H.prototype,c),customElements.define(`page-blog`,H);var U=`.page-contacto{color:#fff;background-color:#252525;border-radius:1rem;flex-direction:column;gap:.5rem;margin:5%;padding:1.5rem;font-family:Open Sans,sans-serif;display:flex}.page-contacto__titulo{text-align:center;color:gold;margin:0 0 1rem;font-family:Fira Code,monospace;font-size:2rem;font-weight:400}.page-contacto__titulo-input{color:gold;margin:.5rem 0 .2rem;font-size:1rem;font-weight:400}.page-contacto input,.page-contacto textarea{box-sizing:border-box;color:#fff;background-color:#1f1f1f;border:1px solid #4b4b4a;border-radius:.5rem;width:100%;padding:.6rem;font-family:Open Sans,sans-serif;font-size:1rem}.page-contacto textarea{resize:vertical;min-height:120px}.page-contacto button{color:#000;background-color:gold;border:1px solid #000;border-radius:.6rem;align-self:flex-start;margin-top:.8rem;padding:.6rem 1.2rem;font-family:Open Sans,sans-serif;font-size:1rem;font-weight:700}`,W=`
...
`,G=class extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.crearHTML()}crearHTML(){this.shadow.innerHTML=W;let e=document.createElement(`style`);e.innerHTML=U,this.shadow.appendChild(e)}};customElements.define(`page-contacto`,G),addEventListener(`DOMContentLoaded`,()=>{C.enrutar()});