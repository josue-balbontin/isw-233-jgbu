...
const proyectos = `<section class="experiencia">
...
const experiencia = `<section class="experiencia">
        ...
        <div class="experiencia__lista">
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="img/inds_inspectionpng.png" alt="Captura de pantalla del Proyecto 1">
            </div>
            <div class="experiencia__proyecto">
                <img class="experiencia__imagen" src="img/whitebelt.png" alt="Captura de pantalla del Proyecto 2">     
                <div>
            ...
            <div class="experiencia__proyecto">
                ...
                <img class="experiencia__imagen" src="img/google.png" alt="Captura de pantalla del Proyecto 3">
            </div>
